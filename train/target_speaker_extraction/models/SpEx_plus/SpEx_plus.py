...
class SpEx_plus(nn.Module):
    def __init__(self, args):
        ...
        norm = args.network_audio.norm
        non_linear = args.network_audio.non_linear
        causal = args.causal
        ...
        # Repeat Conv Blocks
        # n x B x T => n x B x T
        self.conv_block_1 = Conv1DBlock_v2(
            spk_embed_dim=256,
            in_channels=B,
            conv_channels=H,
            kernel_size=P,
        ...
        self.conv_block_1_other = self._build_blocks(
            num_blocks=X,
            in_channels=B,
            conv_channels=H,
            kernel_size=P,
        ...
        self.conv_block_2 = Conv1DBlock_v2(
            spk_embed_dim=256,
            in_channels=B,
            conv_channels=H,
            kernel_size=P,
        ...
        self.conv_block_2_other = self._build_blocks(
            num_blocks=X,
            in_channels=B,
            conv_channels=H,
            kernel_size=P,
        ...
        self.conv_block_3 = Conv1DBlock_v2(
            spk_embed_dim=256,
            in_channels=B,
            conv_channels=H,
            kernel_size=P,
        ...
        self.conv_block_3_other = self._build_blocks(
            num_blocks=X,
            in_channels=B,
            conv_channels=H,
            kernel_size=P,
        ...
        self.conv_block_4 = Conv1DBlock_v2(
            spk_embed_dim=256,
            in_channels=B,
            conv_channels=H,
            kernel_size=P,
        ...
        self.conv_block_4_other = self._build_blocks(
            num_blocks=X,
            in_channels=B,
            conv_channels=H,
            kernel_size=P,
        ...
        self.pred_linear = nn.Linear(256, args.network_audio.speakers)
    ...
    def forward(self, x, aux, aux_len):
        ...
        decoded_1 = self.decoder_1d_1(s1, orig_len, squeeze=False).squeeze(1)
        decoded_2 = self.decoder_1d_2(s2, orig_len, squeeze=False).squeeze(1)[:, :xlen1]
        decoded_3 = self.decoder_1d_3(s3, orig_len, squeeze=False).squeeze(1)[:, :xlen1]

        return decoded_1, decoded_2, decoded_3, self.pred_linear(aux)
...
class ConvTrans1D(nn.ConvTranspose1d):
    ...
    def forward(self, x, T_origin, squeeze=False):
        """
        x: N x L or N x C x L
        """
        if x.dim() not in [2, 3]:
