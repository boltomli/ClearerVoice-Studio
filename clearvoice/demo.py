...
if True:
    ...
    myClearVoice(
        input_path="samples/path_to_input_wavs",
        online_write=True,
    ...
    myClearVoice(
        input_path="samples/scp/audio_samples.scp",
        online_write=True,
        output_path="samples/path_to_output_wavs_scp",
    )
...
if False:
    ...
    output_wav = myClearVoice(input_path="samples/input.wav", online_write=False)
    myClearVoice.write(
        output_wav, output_path="samples/output_MossFormerGAN_SE_16K.wav"
    )
...
if False:
    ...
    # 2nd calling method: process all wav files in 'path_to_input_wavs/' and write outputs to 'path_to_output_wavs'
    myClearVoice(
        input_path="samples/path_to_input_wavs_ss",
        online_write=True,
        output_path="samples/path_to_output_wavs",
    )
    ...
    ##3rd calling method: process wav files listed in .scp file, and write outputs to 'path_to_output_wavs_scp/'
    myClearVoice(
        input_path="samples/scp/audio_samples_mix.scp",
        online_write=True,
        output_path="samples/path_to_output_wavs_scp",
    )
...
if False:
    ...
    myClearVoice(
        input_path="samples/path_to_input_videos_tse",
        online_write=True,
        output_path="samples/path_to_output_videos_tse",
    )

    # 2nd calling method: process video files listed in .scp file, and write outputs to 'path_to_output_videos_tse_scp/'
    myClearVoice(
        input_path="samples/scp/video_samples.scp",
        online_write=True,
        output_path="samples/path_to_output_videos_tse_scp",
    )
