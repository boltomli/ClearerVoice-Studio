...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        help="whether to train from a checkpoint, includes model weight, optimizer settings",
    )
    parser.add_argument(
        "--evaluate_only", type=int, default=0, help="Only perform evaluation"
    )
    ...
    parser.add_argument(
        "--lr_warmup", type=int, default=0, help="whether to perform lr warmup"
    )
    parser.add_argument("--max_epoch", type=int, help="Number of maximum epochs")
    parser.add_argument(
        "--clip_grad_norm", type=float, help="Gradient norm threshold to clip"
    )
    ...
    parser.add_argument(
        "--network_reference", type=dict, help="the nature of auxilary reference signal"
    )
    parser.add_argument(
        "--network_audio",
        type=dict,
    ...
    parser.add_argument(
        "--init_from",
        type=str,
        help="whether to initilize the model weights from a pre-trained checkpoint",
    )
