from clearvoice import (
    ClearVoice,
)  # Import the ClearVoice class for speech processing tasks
...
if __name__ == "__main__":
    ...
    if (
        ...
        myClearVoice.write(
            output_wav, output_path="samples/output_MossFormer2_SE_48K.wav"
        )
    ...
    if (
        ...
        myClearVoice = ClearVoice(
            ...
            model_names=["MossFormer2_SE_48K", "FRCRN_SE_16K"],
        )
