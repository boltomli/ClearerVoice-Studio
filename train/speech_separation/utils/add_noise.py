...
def add_noisem(
    ...
    try:
        ...
        if start < 0:
            noise_selected = np.concatenate([noise, noise[1:] - 0.97 * noise[:-1]])[
                :clean_size
            ]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--clean_wav_list", type=str, default="clean.lst")
    parser.add_argument("--noise_wav_list", type=str, default="noise.lst")
    parser.add_argument("--mix_list", type=str, default="mix.lst")
    parser.add_argument("--generate_mix_wav", type=int, default=0)
    parser.add_argument("--snr_lower", type=int, default=-5)
    parser.add_argument("--snr_upper", type=int, default=20)

    parser.add_argument("--output_clean_dir", type=str, default="../data/wavs/clean")
    parser.add_argument("--output_noisy_dir", type=str, default="../data/wavs/noisy")
