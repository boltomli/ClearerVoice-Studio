                ...
                if not os.path.isfile(ckpt_name):
                    ...
                    if flag == 0:
                        self._load_pretrained_model(
                            checkpoint_path, load_training_stat=True
                        )
                    if flag == 1:
        ...
        if not os.path.isfile(ckpt_name):
            ...
            if "model" in checkpoint:
                try:
                    ...
                    print(
                        "The model is not sucessfully loaded, will try _load_pretrained_model"
                    )
                    return 0
            else:
                print(
        ...
        if os.path.isfile(checkpoint_path):
            ...
            # load the training states
                ...
                for g in self.optimizer.param_groups:
                    g["lr"] = self.args.finetune_learning_rate
                print(
                    f"==> Done model init from {self.args.init_checkpoint_path}. Start finetune training ..."
                )
        else:
    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.args.max_epoch + 1):
            ...
            if self.halving:
                ...
                if self.print:
                    print(
                        "Learning rate adjusted to: {:1.4e}".format(
