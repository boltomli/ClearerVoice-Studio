        ...
        for idx in range(num_samples):
            ...
            for spk in range(args.num_spks):
                ...
                sf.write(
                    os.path.join(
                        output_wave_dir,
                        wav_id.replace(".wav", "_s" + str(spk + 1) + ".wav"),
                    ),
                    output_audio,
                    args.sampling_rate,
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--mode", type=str, default="inference", help="run train or inference"
    )
    parser.add_argument(
        "--checkpoint-dir",
        dest="checkpoint_dir",
    ...
    parser.add_argument(
        "--network",
        type=str,
        help="select speech enhancement models: MossFormer2_SS_16K, MossFormer2_SS_8K",
    )
    parser.add_argument(
